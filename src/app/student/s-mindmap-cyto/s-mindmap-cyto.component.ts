...
@Component({
  selector: 'app-s-mindmap-cyto',
  templateUrl: './s-mindmap-cyto.component.html',
  styleUrls: ['./s-mindmap-cyto.component.css']
})

export class SMindmapCytoComponent implements OnInit {
  flag: boolean;
